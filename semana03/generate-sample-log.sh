...
MENSAJES_ERROR=("Connection timeout after 30 s"
...
MENSAJES_INFO=("User login successful"
...
MENSAJES_WARNING=("Disk usage above 80 percent"
...
for i in $ (seq 1 500); do
    ...
    case "$SEV" in
        "ERROR" | "FATAL")
            MSG=${MENSAJES_ERROR[$((RANDOM % ${#MENSAJES_ERROR[@]}))]};;"WARNING")
            MSG=${MENSAJES_WARNING[$((RANDOM % ${#MENSAJES_WARNING[@]}))]};;*)
            MSG=${MENSAJES_INFO[$((RANDOM % ${#MENSAJES_INFO[@]}))]};;esac
