...
Los archivos de configuracion son sensibles.
Solo el dueno debe poder modificarlos para evitar cambios no autorizados que podrian romper aplicaciones.

### Por que 644 para logs?
Los archivos de log generalmente son escritos por el sistema o la aplicacion (como owner).
Otros usuarios solo necesitan leerlos para diagnostico, no modificarlos.
